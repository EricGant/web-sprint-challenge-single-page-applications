...
its used to copy the previous code in the path name set to url, and the url will match the deepr you go

1. How would you explain form validation to someone who has never programmed before?
form validation is settings checks on the form to ensure the correct data is put in the correct form, if it doesnt fit the validation it will not pass

1. In 1-2 sentences, define end to end testing.
Writing tests to simulate a users various actions across a website. 
